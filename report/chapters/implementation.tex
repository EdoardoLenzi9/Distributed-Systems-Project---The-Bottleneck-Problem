...
\begin{itemize}
    ...
    at the same time
    \item $bridge\_length$: it defines the lenght of the bridge
...
Each car knows also the $bridge\_capacity$ and $bridge\_length$ that are imposed by the environment and cannot change during the
simulation.\\
